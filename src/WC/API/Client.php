...
class WC_API_Client
{
     ...
     * @return mixed|json string
     */
    public function create_order( $parameters = array() )
    {
        return $this->_make_api_call( 'orders', $parameters, 'POST' );
    }
     ...
     * @return mixed|json string
     */
    public function create_customer( $parameters = array() )
    {
        return $this->_make_api_call( 'customers', $parameters, 'POST' );
    }
     ...
     * @return mixed|json string
     */
    private function _make_api_call( $endpoint, $data = array(), $method = 'GET' )
    {
        $ch = curl_init();
